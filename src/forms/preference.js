  ...
  groups: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Logo URL",
          placeholder: "",
          info: "The logo should be stored in your Google Drive and it must be public. You can get the URL by clicking on Get Link.",
          model: "logo_url",
          validator: ["required"],
        ...
        },
        {
          ...
          required: true,
          values: function () {
            return ["en-GB", "en-US", "de-DE", "af-ZA"];
          },
          // default: "en-US",
          validator: ["required"],
        ...
        {
          type: "radios",
          label: "Add task in Google Calendar",
        ...
        },
        {
          type: "input",
          inputType: "text",
          label: "Embed Code for Calendars",
          placeholder: "",
          info: "The logo should be stored in your Google Drive and it must be public. You can get the URL by clicking on Get Link.",
          model: "embed_code_calendar",
          validator: ["required"],
